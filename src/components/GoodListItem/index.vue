<template>
  <router-link class="good_list_item_link" :to="`/detail/${goodListItem.id}`">
    <div class="goodListItem">
      <img class="image" :src="goodListItem.image" alt="" />
      <div class="desc">
        <div class="name text_hidden_1">{{ goodListItem.store_name }}</div>
        <div class="price">
          <div class="defaul flex-row">￥{{ goodListItem.price }}</div>
          <div class="vip_price flex-space">
            <div class="flex-row">
              <span>￥{{ goodListItem.vip_price }}</span>
              <img
                class="vip"
            ...
            <div class="count">已售{{ goodListItem.sales }}</div>
          </div>
        </div>
      </div>
    </div>
